...
export const hasbledCalculator: CalculatorDefinition = {
  ...
  screeningQuestions: [
    ...
    },
    {
      ...
      type: 'boolean',
      eliminates: true,
      eliminationMessage: 'This calculator was specifically designed for patients with atrial fibrillation. Results may not be applicable to other patient populations.',
    },
  ],
  calculate: (params) => {
    let score = 0;
  ...
  screeningQuestions: [
    {
      ...
      type: 'boolean',
      eliminates: true,
      eliminationMessage: 'This calculator is specifically designed for patients with atrial fibrillation. Results may not be applicable to other patient populations.',
    },
  ],
  calculate: (params) => {
    let score = 0;
  ...
  screeningQuestions: [
    {
      ...
      type: 'boolean',
      eliminates: true,
      eliminationMessage: 'This calculator was primarily validated in patients with hepatitis B or C. Results may be less reliable in other liver conditions.',
    },
    {
      id: 'liverDisease',
      ...
      type: 'boolean',
      eliminates: true,
      eliminationMessage: 'This calculator is designed to assess liver fibrosis. It may not be applicable for other clinical questions.',
    },
  ],
  calculate: (params) => {
  ...
  screeningQuestions: [
    {
      ...
      type: 'boolean',
      eliminates: true,
      eliminationMessage: 'This calculator is specifically designed for patients with rheumatoid arthritis. Results may not be applicable to other inflammatory conditions.',
    },
    {
      id: 'esrAvailable',
  ...
  screeningQuestions: [
    {
      ...
      type: 'boolean',
      eliminates: true,
      eliminationMessage: 'This calculator is validated for patients aged 30-79 years. Results may be less reliable outside this age range.',
    },
    {
      id: 'priorCVD',
  ...
  screeningQuestions: [
    {
      ...
      type: 'boolean',
      eliminates: true,
      eliminationMessage: 'This calculator is designed for cardiovascular risk assessment. It may not be applicable for other clinical questions.',
    },
  ],
  calculate: (params) => {
...
export const combinedCVRiskCalculator: CalculatorDefinition = {
  ...
  screeningQuestions: [
    ...
    },
    {
      ...
      type: 'boolean',
      eliminates: true,
      eliminationMessage: 'Framingham risk scoring is validated for patients aged 30-79 years. Results may be less reliable outside this age range.',
    },
  ],
  calculate: (params) => {
